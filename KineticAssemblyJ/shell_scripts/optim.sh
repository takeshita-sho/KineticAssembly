...
#SBATCH --output="optim_job_%A_%a.out"
#SBATCH --error="optim_job_%A_%a.err"
...
#SBATCH --array=1-6  # Total combinations of nmer sizes and integrators
...
julia +1.10.0 ./optim.jl "$nmer_size" 1 .01 f "KenCarp4()"
